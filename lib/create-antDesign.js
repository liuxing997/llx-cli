...
const git = "liuxing997/vite-vue3-ts-vueRouter-pinia-AntDesign#template";

const createQuestions = [
  {
    name: "description",
    message: "Input the project description: ",
    default: "vite-vue3-ts-vueRouter-pinia-antDesign",
  },
  {
    name: "version",
...
// 创建AntDesign项目
const createAntDesign = (projectName) => {
...
module.exports = createAntDesign;
