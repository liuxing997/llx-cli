...
const git = "liuxing997/vite-vue3-ts-vueRouter-pinia-viewDesign#template";

const createQuestions = [
  {
    name: "description",
    message: "Input the project description: ",
    default: "vite-vue3-ts-vueRouter-pinia-viewDesign",
  },
  {
    name: "version",
...
// 创建ViewDesign项目
const createViewDesign = (projectName) => {
...
module.exports = createViewDesign;
