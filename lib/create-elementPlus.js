...
const git = "liuxing997/vite-vue3-ts-vueRouter-pinia-elementPlus#template";

const createQuestions = [
  {
    name: "description",
    message: "Input the project description: ",
    default: "vite-vue3-ts-vueRouter-pinia-elementPlus",
  },
  {
    name: "version",
...
// 创建ElementPlus项目
const createElementPlus = (projectName) => {
...
module.exports = createElementPlus;
