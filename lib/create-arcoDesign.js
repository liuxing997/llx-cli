...
const git = "liuxing997/vite-vue3-ts-vueRouter-pinia-arcoDesign#template";

const createQuestions = [
  {
    name: "description",
    message: "Input the project description: ",
    default: "vite-vue3-ts-vueRouter-pinia-arcoDesign",
  },
  {
    name: "version",
...
// 创建createArcoDesign项目
const createArcoDesign = (projectName) => {
...
module.exports = createArcoDesign;
